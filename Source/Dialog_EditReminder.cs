...
namespace Riminder
{
    public class Dialog_EditReminder : Window
    {
        ...
        public Dialog_EditReminder(Reminder reminder)
        {
            ...
            if (ticksRemaining > 0)
            {
                days = ticksRemaining / GenDate.TicksPerDay;
                hours = (ticksRemaining % GenDate.TicksPerDay) / GenDate.TicksPerHour;
            }
            else
            {
                days = 0;
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            try
            {
                ...
                Widgets.Label(new Rect(LeftMargin, 10f, contentWidth, ControlHeight), "Edit Reminder");
                ...
                currentY += ControlHeight + 15f; // Added more vertical spacing
                ...
                currentY += 80f + 15f; // Added more vertical spacing
